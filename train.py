...
parser.add_argument('--model', type=str, default='vgg11', help='Choose between VGG and Densenet')
...
if args.model == 'vgg11':
    ...
    number_inputs = model.classifier[0].in_features
    structure = 'vgg11'
    ...
    print("Please use either  vgg11 or densenet161")
...
model.classifier = nn.Sequential(nn.Linear(number_inputs, 4096),
                                 nn.ReLU(),
                                 nn.Dropout(0.2),
                                 nn.Linear(4096, 1024),
                                 nn.ReLU(),
